...
namespace daan.web
{
    public class PageBase : System.Web.UI.Page
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (Userinfo == null) { Response.Redirect("~/Timeout.aspx", true); }


            //恶意连续点击等操作该对象为空时重新转向本页面，不好的之处在于之前操作会丢失
            //如有更好的解决办法替换掉这里
            //add by lee
            if (PageManager.Instance == null)
            {
                string url = Request.Url.LocalPath;
                if (!url.Contains("RepShowView"))//iframe中的PageManager.Instance一直为空
                {
        ...
        /// <summary>获取打印所需的客户端配置信息
        /// 
        /// </summary>
        /// <param name="hostmac">通过ActiveX获取到的客户端mac地址</param>
        public void SetInitlocalsetting(string hostmac)
        {
        ...
        {
            Alert.ShowInTop(msg, "体检系统");
        }

        /// <summary>弹出提示框 可设计提示框警示图片
        /// 
        /// </summary>
        /// <param name="msg">提示内容</param>
        /// <param name="icon">警示图片</param>
        protected void MessageBoxShow(string msg, MessageBoxIcon icon)
        {
            Alert.ShowInTop(msg, "体检体统", icon);
        }
