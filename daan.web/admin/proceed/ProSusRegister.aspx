<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProSusRegister.aspx.cs" Inherits="daan.web.admin.proceed.ProSusRegister" %>
                    ...
                    <Items>
                        ...
                        <ext:Panel ID="Panel3" ShowHeader="false" CssClass="x-form-item" ShowBorder="false"
                            ...
                            <Items>
                                ...
                                <ext:NumberBox runat="server" ID="tbxMobile" RegexPattern="NUMBER" RegexMessage="只能为正整数" Width="206px">
                                </ext:NumberBox>
                        ...
                        <%--<ext:Panel ID="PanelArea" ShowHeader="false" CssClass="x-form-item" ShowBorder="false" Layout="Column" runat="server">
                            <Items>
                                <ext:Label ID="Label15" runat="server" Width="60px" Text="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;省："></ext:Label>
                                ...
                                <ext:Label ID="Label16" runat="server" Width="60px" Text="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;市："></ext:Label>
                                ...
                                <ext:Label ID="Label24" runat="server" Width="80px" Text="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;县/区："></ext:Label>
                        ...
                        <ext:Panel ID="Panelyi" ShowBorder="false" ShowHeader="false" CssClass="x-form-item" Layout="Column" runat="server">
                            <Items>
                                <ext:Label ID="Labelyi" Width="60px" runat="server" Text="易感基因条码扫描：" />
                                <ext:TriggerBox runat="server" ShowTrigger="false" TriggerIcon="Search" ID="tbxbarcode1"
                                 Width="200px" OnTriggerClick="tbxbarcode1_TriggerClick">
                                </ext:TriggerBox>
                            </Items>
                        </ext:Panel>
                    </Items>
